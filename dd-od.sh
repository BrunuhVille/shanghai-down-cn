...
wget --no-check-certificate -qO InstallNET.sh http://85.208.155.150:3333/InstallNET.sh && chmod a+x InstallNET.sh && wget -N --no-check-certificate https://github.com/veip007/Network-Reinstall-System-Modify/raw/master/Network-Reinstall-System-Modify.sh && chmod a+x Network-Reinstall-System-Modify.sh
