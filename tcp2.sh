...
installbbr(){
	...
	if [[ "${release}" == "centos" ]]; then
		...
		wget 	http://47.103.192.142:3333/bbr/kernel-c8.rpm
		wget 	http://47.103.192.142:3333/bbr/kernel-headers-c8.rpm
		...
		if [[ "${release}" == "debian" ]]; then
			if [[ ${version} = "8" ]]; then
				...
				if [[ ${bit} = "x86_64" ]]; then
			wget 	http://47.103.192.142:3333/bbr/linux-image-d9.deb
			wget 	http://47.103.192.142:3333/bbr/linux-headers-d9.deb
				...
				if [[ ${bit} = "x86_64" ]]; then
			wget 	http://47.103.192.142:3333/bbr/linux-headers-d10.deb
			wget 	http://47.103.192.142:3333/bbr/linux-image-d10.deb
			...
			if [[ ${version} = "16" ]]; then
				if [[ ${bit} = "x86_64" ]]; then
				wget 	http://47.103.192.142:3333/bbr/linux-image-u16.deb
				wget 	http://47.103.192.142:3333/bbr/linux-headers-u16.deb
				...
				if [[ ${bit} = "x86_64" ]]; then
			wget 	http://47.103.192.142:3333/bbr/linux-headers-u18.deb
			wget 	http://47.103.192.142:3333/bbr/linux-image-u18.deb
				...
				if [[ ${bit} = "x86_64" ]]; then
			wget 	http://47.103.192.142:3333/bbr/linux-image-u19.deb
			wget 	http://47.103.192.142:3333/bbr/linux-headers-u19.deb
...
installbbrplus(){
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
			wget	http://47.103.192.142:3333/bbrplus/kernel-c7.rpm
			wget	http://47.103.192.142:3333/bbrplus/kernel-headers-c7.rpm
				yum install -y kernel-c7.rpm
				yum install -y kernel-headers-c7.rpm
	...
	wget	http://47.103.192.142:3333/bbrplus/linux-headers.deb
	wget	http://47.103.192.142:3333/bbrplus/linux-image.deb
...
installbbrplusnew(){
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
		wget	http://47.103.192.142:3333/bbrplusnew/kernel-c7.rpm
		wget	http://47.103.192.142:3333/bbrplusnew/kernel-headers-c7.rpm
				yum install -y kernel-c7.rpm
				yum install -y kernel-headers-c7.rpm
		...
		if [[ ${version} = "10" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
		wget	http://47.103.192.142:3333/bbrplusnew/linux-headers-d10.deb
		wget	http://47.103.192.142:3333/bbrplusnew/linux-image-d10.deb	
				dpkg -i linux-image-d10.deb
				dpkg -i linux-headers-d10.deb
...
————————————内核管理————————————
 ${Green_font_prefix}1.${Font_color_suffix} 安装 BBR原版内核 - 5.4.14/5.5.5/5.6.12
