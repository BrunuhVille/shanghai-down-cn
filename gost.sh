...
function Install_ct() {
  ...
  wget --no-check-certificate http://132.145.93.138:3333/gost/gost-linux-amd64-2.11.1.gz
  gunzip gost-linux-"$bit"-"$ct_new_ver".gz
  mv gost-linux-"$bit"-"$ct_new_ver" gost
  mv gost /usr/bin/gost
  chmod -R 777 /usr/bin/gost
  wget --no-check-certificate http://132.145.93.138:3333/gost/gost.service && chmod -R 777 gost.service && mv gost.service /usr/lib/systemd/system
  mkdir /etc/gost && wget --no-check-certificate http://132.145.93.138:3333/gost/config.json && mv config.json /etc/gost && chmod -R 777 /etc/gost
