...
installbbr2(){
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
			wget	http://47.103.192.142:3333/bbr2/kernel-c7.rpm
			wget	http://47.103.192.142:3333/bbr2/kernel-headers-c7.rpm
				yum install -y kernel-c7.rpm
				yum install -y kernel-headers-c7.rpm
...
installbbrplusnew(){
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
			wget http://47.103.192.142:3333/bbrpnew/kernel-c7.rpm
			wget http://47.103.192.142:3333/bbrpnew/kernel-headers-c7.rpm
				yum install -y kernel-c7.rpm
				yum install -y kernel-headers-c7.rpm
